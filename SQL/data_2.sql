...
SELECT  a.hire_date,last_day(a.hire_date)Ult_dia from  EMPLOYEES a;
...
SELECT TRUNC((MONTHS_BETWEEN(SYSDATE, TO_DATE('21/01/1996','dd/mm/yyyy')))/12) AS idade FROM DUAL;

SELECT TRUNC((MONTHS_BETWEEN(SYSDATE, TO_DATE('05/11/1996','dd/mm/yyyy')))) AS idade_MESES FROM DUAL

--DIAS DE VIDA

SELECT SYSDATE-TO_DATE('05/11/1996','dd/mm/yyyy') FROM DUAL;

--DIAS DE VIDA
SELECT TRUNC(SYSDATE-TO_DATE('05/11/1996','dd/mm/yyyy')) DIAS FROM DUAL;
