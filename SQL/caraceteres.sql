...
-- Exemplos com LTRIM( )
SELECT a.JOB_TITLE,
       LTRIM(a.JOB_TITLE,'A') posicao FROM JOBS a;

SELECT a.JOB_TITLE,LTRIM(a.JOB_TITLE,'AFPS') posicao FROM JOBS a;
...
-- Exemplos com RTRIM( )
SELECT a.JOB_TITLE,RTRIM(a.JOB_TITLE,'tre') posicao FROM JOBS a;
--exemplo
...
-- Exemplos com LENGTH( )
SELECT a.JOB_TITLE,
       LENGTH(a.JOB_TITLE) tamanho FROM JOBS a;
...
SELECT a.JOB_TITLE,TRANSLATE(a.JOB_TITLE,'PAF','XYZ') traducao FROM JOBS a;

-- Exemplos com REPLACE( )
SELECT a.JOB_TITLE,
       REPLACE(a.JOB_TITLE,'Manager','Gerente') 
       traducao FROM JOBS a;

-- Exemplos com DECODE( ) - Funções de conversão 

SELECT a.JOB_TITLE  FROM JOBS a;
